...
namespace	TrabalhoIntermedio
{
	...
	class ProgramEleiçoes
	{
		...
		static public void	anuncio(ref Boletim listaDeCandidatos)
		{
			...
			Console.WriteLine($"Candidato com mais votos: Candidato {candidatoVencedor} com {maiorVotos} votos.");
			Console.WriteLine($"Com uma percentagem de {(maiorVotos * 100) / listaDeCandidatos.votosTotais}%");
